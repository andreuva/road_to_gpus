#
# usage:   gnuplot  "./h7n9_v4.gpu.gnuplot"                         
# purpose: fit the obtained immune-response-modulated growth pattern
#          of some h7n9 virus currently stored to file './h7n9_v4.gpu.1.dat'
#          with a gaussian function;
#
 set terminal postscript eps enhanced solid  color
 set encoding iso_8859_1
 set output "h7n9_v4.gpu.eps"
 ...
 fit immnty(x) "./h7n9_v4.gpu.1.dat" using 1:2 via a,b,c
 ...
 plot "./h7n9_v4.gpu.1.dat" using 1:2 with lines lw 3, immnty(x) with linespoints lw 3
