 ...
 *               n.b.3 here the core part of the simulation is run on the 
 ...
 *               results;
 * compilation:  nvcc ./h7n9_v2.cu
 * usage:        ./a.out  >  ./h7n9_v2.gpu.0.dat 
 *               tail -130 ./h7n9_v2.gpu.0.dat | head -126  >  ./h7n9_v2.gpu.1.dat
 *               gnuplot  "./h7n9_v2.gpu.gnuplot"
 *               gs ./h7n9_v2.gpu.eps                       
 */
...
{
    int i;
    float cell_type_count[] = {   500000.00e05,
                                    1490.00e05,
                                    1230.00e05,
                                     806.00e05,
                                     703.00e05,
